...
const PAGE_TITLES = {
  ...
  '/rentabilidad-linea': 'Rentabilidad por Linea',
  '/reportes-simplificados': 'Reportes Simplificados',
  '/unidades-internas': 'Unidades Internas',
  '/cargos-internos': 'Cargos Internos',
  '/gastos-unidad-interna': 'Gastos por Unidad',
  '/reporte-unidades-internas': 'Reporte Gerencial',
  '/planilla': 'Planilla',
